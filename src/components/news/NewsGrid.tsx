        ...
        <article key={item.guid}>
          {item.link ? (
            <a
              ...
              className="group block bg-card/50 backdrop-blur-sm rounded-lg overflow-hidden border border-border/50 hover:border-primary/20 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
            >
            ...
            <div className="group block bg-card/50 backdrop-blur-sm rounded-lg overflow-hidden border border-border/50">
              <div className="relative h-48 overflow-hidden">
                <img
                  src={item.thumbnail}
                  alt={item.title}
