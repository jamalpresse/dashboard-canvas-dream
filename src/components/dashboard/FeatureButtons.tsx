...
export const FeatureButtons: React.FC = () => {
  ...
  return <div className="mx-4 md:mx-8">
      ...
      <Link to="/image-generation" className="group relative overflow-hidden flex w-full bg-gradient-data hover:scale-[1.02] text-white font-semibold py-6 px-6 rounded-xl shadow-elegant hover:shadow-glow transition-all duration-300 justify-center items-center space-x-3 mb-6">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity bg-rose-600" />
      </Link>
    </div>;
};